...
from websockets.client import connect # 웹소켓 클라이언트 (Moonraker 접속용)
from websockets.exceptions import ConnectionClosedOK
import asyncio

# --- 설정 ---
# Moonraker 웹소켓 주소 설정 (FastAP와 Moonraker 연동을 위한 주소)
...
@router.websocket("/ws") # 클라이언트(Mainsail)가 접속할 경로 , 클라이언트는 FastAPI를 통해 접속.
